...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
	...
	if(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "WindowsStore")
		string(REPLACE "Project(\"{8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942}\") = \"lame\", \"x64_vc11_lame_lame.vcxproj\", \"{EEF5B49E-DBD1-4E1B-8B86-C5D64FCBAD38}\"" "" sln_con "${sln_con}")
		string(REPLACE "ProjectSection(ProjectDependencies) = postProject" "" sln_con "${sln_con}")
		string(REPLACE "{92BD50AA-04D6-4FBF-ACE1-468FAF6778F2} = {92BD50AA-04D6-4FBF-ACE1-468FAF6778F2}" "" sln_con "${sln_con}")
		string(REPLACE "EndProjectSection\nEndProject" "" sln_con "${sln_con}")
		string(REPLACE "{EEF5B49E-DBD1-4E1B-8B86-C5D64FCBAD38}.Debug|x64.ActiveCfg = Debug|x64" "" sln_con "${sln_con}")
		string(REPLACE "{EEF5B49E-DBD1-4E1B-8B86-C5D64FCBAD38}.Debug|x64.Build.0 = Debug|x64" "" sln_con "${sln_con}")
		string(REPLACE "{EEF5B49E-DBD1-4E1B-8B86-C5D64FCBAD38}.Release|x64.ActiveCfg = Release|x64" "" sln_con "${sln_con}")
		string(REPLACE "{EEF5B49E-DBD1-4E1B-8B86-C5D64FCBAD38}.Release|x64.Build.0 = Release|x64" "" sln_con "${sln_con}")
	endif()
